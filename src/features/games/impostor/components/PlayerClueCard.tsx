...
const resolveTone = (tone: PlayerClueCardTone, theme: ThemeTokens) => {
  if (tone === 'submitted') {
    return {
      borderColor: withAlpha(theme.semantic.button.primary.bg, 0.26),
      cardBg: withAlpha('#FFFFFF', 0.94),
      shadowColor: withAlpha(theme.semantic.button.primary.bg, 0.35),
      avatarBg: withAlpha(theme.semantic.button.primary.bg, 0.1),
      avatarBorder: withAlpha(theme.semantic.button.primary.bg, 0.18),
      statusBg: withAlpha(theme.semantic.button.primary.bg, 0.12),
      statusBorder: withAlpha(theme.semantic.button.primary.bg, 0.2),
      statusText: theme.semantic.button.primary.bg,
      emphasisText: theme.semantic.button.primary.bg,
      historyBg: withAlpha(theme.semantic.button.primary.bg, 0.05),
      historyBorder: withAlpha(theme.semantic.button.primary.bg, 0.08),
      historyChipBg: withAlpha(theme.semantic.button.primary.bg, 0.1),
      historyChipBorder: withAlpha(theme.semantic.button.primary.bg, 0.12),
    };
  }

  if (tone === 'typing') {
    return {
      borderColor: withAlpha(theme.semantic.status.warning, 0.28),
      cardBg: withAlpha('#FFFFFF', 0.94),
      shadowColor: withAlpha(theme.semantic.status.warning, 0.28),
      avatarBg: withAlpha(theme.semantic.status.warning, 0.12),
      avatarBorder: withAlpha(theme.semantic.status.warning, 0.18),
      statusBg: withAlpha(theme.semantic.status.warning, 0.14),
      statusBorder: withAlpha(theme.semantic.status.warning, 0.18),
      statusText: '#996C16',
