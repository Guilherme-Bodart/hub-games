...
export function buildRevealCardVisualTokens(
  ...
  const accentColor = isImpostor ? theme.semantic.status.error : theme.semantic.button.primary.bg;
  const accentSecondaryColor = mode === 'number' ? LOBBY_GLOW_CYAN : theme.semantic.button.accent.bg;
  const shellToneColors: [string, string, string] = isImpostor
    ? [
  ...
  const shellBackgroundColor = withAlpha(
    isImpostor ? shiftHexColor(theme.semantic.bg.surface, 0.03) : CLASSIC_CARD_BASE,
    0.96
  );
  ...
  return {
    ...
    avatarHaloShadowColor: withAlpha(accentSecondaryColor, isImpostor ? 0.18 : 0.64),
    cardBadgeBackgroundColor: withAlpha(accentColor, isImpostor ? 0.94 : 0.96),
    cardBadgeBorderColor: withAlpha(shiftHexColor(accentColor, -0.08), isImpostor ? 0.84 : 0.84),
    cardBadgeShadowColor: withAlpha(accentColor, isImpostor ? 0.24 : 0.32),
    cardBadgeTextColor: isImpostor ? withAlpha('#FFF6F2', 0.98) : theme.semantic.button.primary.text,
    cardCornerColor: withAlpha(isImpostor ? accentColor : accentSecondaryColor, isImpostor ? 0.42 : 0.5),
    cardInsetColor: withAlpha(isImpostor ? IMPOSTOR_PAPER_EDGE : '#FFFFFF', 0.94),
    cardPatternColor: withAlpha(isImpostor ? IMPOSTOR_PAPER_TEXTURE : accentSecondaryColor, isImpostor ? 0.58 : 0.18),
    cardPipColor: withAlpha(isImpostor ? '#FFF4EE' : '#FFF9EF', 0.96),
    chargeBorderColor: withAlpha(accentSecondaryColor, isImpostor ? 0.42 : 0.98),
    chargeShadowColor: withAlpha(accentSecondaryColor, isImpostor ? 0.32 : 0.96),
    chargeSweepColors: [
      withAlpha('#FFFFFF', 0),
      withAlpha(accentColor, isImpostor ? 0.12 : 0.22),
      withAlpha('#FFFFFF', 0),
    ],
    glossColors: isImpostor
    ...
    revealHeaderBackgroundColor: withAlpha(accentColor, isImpostor ? 0.1 : 0.14),
    revealHeaderBorderColor: withAlpha(accentColor, isImpostor ? 0.28 : 0.38),
    ...
    revealSurfaceBackgroundColor: isImpostor
      ? withAlpha(IMPOSTOR_PAPER_BASE, 0.98)
      : withAlpha(accentColor, mode === 'secret' ? 0.06 : 0.09),
    revealSurfaceBorderColor: withAlpha(accentColor, isImpostor ? 0.2 : 0.34),
    revealTextColor: isImpostor ? theme.semantic.status.error : theme.semantic.text.primary,
    shellBackgroundColor,
    shellBorderColor: withAlpha(isImpostor ? accentColor : accentColor, isImpostor ? 0.42 : 0.52),
    shellFrameInnerColor: withAlpha(isImpostor ? accentColor : accentSecondaryColor, isImpostor ? 0.28 : 0.42),
    shellFrameOuterColor: withAlpha(accentColor, isImpostor ? 0.28 : 0.4),
    shellShadowColor: withAlpha(theme.semantic.shadow.base, isImpostor ? 0.64 : 0.8),
    shellToneColors,
